// Copy from github.com/emersion/go-imap/read.go
package main
...
func (r *Reader) ReadLiteral() (imap.Literal, error) {
	char, _, err := r.ReadRune()
	if err != nil {
		return nil, err
...
func (r *Reader) ReadRespCode() (code imap.StatusRespCode, fields []interface{}, err error) {
	char, _, err := r.ReadRune()
	if err != nil {
		return
	}
	...
	code = imap.StatusRespCode(strings.ToUpper(codeStr))
